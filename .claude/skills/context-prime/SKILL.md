---
name: context-prime
description: Prime a fresh agent session by loading this repo's own .claude/context/*.md files (project-overview, project-brief, tech-context, progress, project-structure, system-patterns, product-context, project-style-guide, project-vision). Use at the start of a session, when asked to "prime context", "load context", "/context:prime", or when resuming work here without prior conversation history.
---

This repo already has a populated `.claude/context/` (9 files, written by an
...
**Tier 1 — essential:**
1. `.claude/context/project-overview.md`
2. `.claude/context/project-brief.md`
3. `.claude/context/tech-context.md`

**Tier 2 — current state:**
4. `.claude/context/progress.md`
5. `.claude/context/project-structure.md`

**Tier 3 — deep context:**
6. `.claude/context/system-patterns.md`
7. `.claude/context/product-context.md`
8. `.claude/context/project-style-guide.md`
9. `.claude/context/project-vision.md`
...
- A listed file that's absent or empty: skip it, note it in the summary,
  keep going.
- `.claude/context/` missing or entirely empty: say so and stop — point at
  ...
  exist here.
- New `.md` files appear in `.claude/context/` that aren't in the tiers
