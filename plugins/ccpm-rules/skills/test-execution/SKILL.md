---
name: test-execution
description: Use when a CCPM testing command or the test-runner agent needs to execute a test suite. Covers routing all execution through the log-capturing test script.
---
...
1. **Always use the `test-runner` agent**
