...
description: Use when CCPM commands create, sync, or merge epic/issue branches. Covers the branch-per-epic parallel execution strategy as an alternative to worktrees.
---
