...
description: Use when reading or writing YAML frontmatter on PRD, epic, or task markdown files. Covers the status vocabulary per file type and the rule to never mutate created, always bump updated.
---
