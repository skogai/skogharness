...
description: Use before any CCPM command writes to GitHub (issues, comments, sub-issues). Covers repo-safety bail-out for the automazeio/ccpm template repo and passing --repo explicitly.
---
