...
description: Use when multiple agents work in parallel inside the same epic worktree. Covers file-level ownership, commit discipline, and conflict avoidance rules for CCPM parallel execution.
---
