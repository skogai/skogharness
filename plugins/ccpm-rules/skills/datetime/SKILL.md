---
name: datetime
description: Use whenever a CCPM command or script needs a timestamp for frontmatter (created/updated) or output. Never write a placeholder date; always shell out to date -u for the real value.
---
