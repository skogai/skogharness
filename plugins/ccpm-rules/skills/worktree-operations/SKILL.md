...
description: Use when CCPM commands create or manage git worktrees for parallel epic execution. Covers the sibling-directory convention and cleanup rules.
---
