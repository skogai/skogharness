...
description: Use before sending any local markdown files content to a GitHub issue or comment. Covers the sed pattern for stripping YAML frontmatter first.
---
