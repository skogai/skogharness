---
name: use-ast-grep
description: Use when a CCPM command or agent needs to search or refactor code structurally instead of by text or regex. Covers when to prefer ast-grep over grep.
---
